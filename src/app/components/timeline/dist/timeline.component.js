...
var asses_param_1 = require("src/app/models/asses-param");
var TimelineComponent = /** @class */ (function () {
    function TimelineComponent(chartService, globalService) {
        this.chartService = chartService;
        this.globalService = globalService;
        this.AssessMeasures = asses_param_1.AssessmentLevels;
    }
    TimelineComponent.prototype.ngOnInit = function () {
        this.schedules.forEach(function (x) {
            var i = Math.floor(Math.random() * 4);
            x.lesson.avgAssess = asses_param_1.AssessmentLevels[i];
        });
    };
