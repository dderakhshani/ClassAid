...
export const AssessmentLevels: AssessMeasureLevel[] = [
    ...
    { title: "نیاز به تلاش", shortTitle: 'ن.ب.ت', value: 1, color: "#eb445a", bdColor: "text-danger", ionColor: "danger", ionIcon: "close-circle-outline" },
    { title: "قابل قبول", shortTitle: 'ق.ق', value: 2, color: "#ffc409", bdColor: "text-warning", ionColor: "warning", ionIcon: "alert-circle-outline" },
